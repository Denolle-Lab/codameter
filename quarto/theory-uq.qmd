---
title: "A hierarchical Bayesian theory of uncertainty for $\\delta v/v$ stress meters"
...
ultimately cares about — stress at depth, pressure sensitivity, water-table
...
### 3a. Decoupled regime → linear-Gaussian, *closed form*
...
### 3b. Coupled regime → non-Gaussian, *sampled*
...
## 5. Priors that encode physics, not convenience
...
## 6. The point of it all: propagating uncertainty to stress
...
## 7. Closing the loop: posterior predictive checks
...
## 8. Summary — the hierarchical model in one diagram

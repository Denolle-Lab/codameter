...
- 2026-09-13: P4 executed on branch `iter3/P4` (commit 04edd37) for issue #42: DOI-aware key reuse (Obermann2013b), denominators (103 publications, 96 measuring, 82 full text, 75 full text measuring), coded uncertainty rates (57 / 11 / 7), documented provenance. Row verification and the search queries stay with the author in #48; the Yuan regime with #47.

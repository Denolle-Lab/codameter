...
0.62 at the three stations (the centred rule of
Table\textasciitilde{}\ref{tab:gate1}) against 0.99, 0.90 and 0.83 under
the matched rule, even on a real annual cycle. We match by applying the
same trailing 90-day mean to the daily series (at least 45 finite days
in the window), compare demeaned --- the two products reference
different epochs, and a constant offset is bookkeeping, not error ---
and exclude the first 150 days of each station's series as reference
burn-in. The comparison is computed by a script archived with the paper

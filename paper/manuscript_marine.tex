...
publication when it measures a temporal relative velocity change from
...
coding and the eight cells coded by hand are recorded with the
machine-readable table, together with these counts.
